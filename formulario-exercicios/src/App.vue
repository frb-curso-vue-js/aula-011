		...
		<div class="conteudo">
			<form class="painel" v-if="!submitted">
				...
				<Rotulo nome="Características do Problema">
					<span class="mr-4"><input type="checkbox" value="reproduzivel" v-model="carac"> Reproduzível</span>
					<span><input type="checkbox" value="intermitente" v-model="carac"> Intermitente</span>
				</Rotulo>
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="p in prioridades" :key="p.codigo" :value="p.codigo" :selected="p.codigo === 1">{{p.codigo}} — {{p.nome}}</option>
					</select>
				</Rotulo>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<ul>
						<li v-for="item in carac" :key="item">
							{{item}}
						</li>
					</ul>
				</Rotulo>
